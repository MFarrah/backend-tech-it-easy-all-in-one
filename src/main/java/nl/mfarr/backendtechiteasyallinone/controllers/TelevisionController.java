package nl.mfarr.backendtechiteasyallinone.controllers;
import nl.mfarr.backendtechiteasyallinone.entities.Television;
...
public class TelevisionController {
    ...
    private final List<Television> televisionList = new ArrayList<Television>();
